...
const Header = () => {
  return (
    <>
<div className={tw.flex.flex_col.justify_between.space_y_4.items_center.bg_black.bg_opacity_30.px_4.w_full.h_['60px'].md(tw.flex.flex_row.justify_between.space_y_0)}>
